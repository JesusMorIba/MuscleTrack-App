...
mixin _$SignupState {
  ...
  SignupEvent get event => throw _privateConstructorUsedError;
...
class _$SignupStateImpl implements _SignupState {
  ...
  @override
  String toString() {
    return 'SignupState(isFormPosted: $isFormPosted, isValid: $isValid, isLoading: $isLoading, email: $email, password: $password, error: $error, event: $event)';
  }
...
abstract class _SignupState implements SignupState {
  factory _SignupState(
      ...
      final Password password,
      final String? error,
      final SignupEvent event}) = _$SignupStateImpl;
